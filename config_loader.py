...
def load_settings() -> dict:
    ...
    env_map = {
        ...
        "LLAMA_CPP_MODEL_REPO_ID": ("model", "model_repo_id"),
        "LLAMA_CPP_MODEL_FILENAME": ("model", "model_filename"),
        "LLAMA_CPP_N_GPU_LAYERS": ("model", "n_gpu_layers"),
        "LLAMA_CPP_N_BATCH": ("model", "n_batch"),
        "LLAMA_CPP_N_UBATCH": ("model", "n_ubatch"),
        "LLAMA_CPP_FLASH_ATTN": ("model", "flash_attn"),
        "LLAMA_CPP_OP_OFFLOAD": ("model", "op_offload"),
        "LLAMA_CPP_SWA_FULL": ("model", "swa_full"),
